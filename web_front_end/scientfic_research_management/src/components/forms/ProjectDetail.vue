        ...
        <mu-container>
          <mu-form :model="form" class="mu-demo-form" :label-position="labelPosition" label-width="100">
            ...
            <mu-form-item class="mu-demo-min-form float_left" prop="radio" label="学科门类">
              <mu-radio v-model="form.radio" value="male" label="理工科" disabled></mu-radio>
              <mu-radio v-model="form.radio" value="female" label="社科" disabled></mu-radio>
            </mu-form-item>
            ...
            <mu-form-item style="margin: 10px;" prop="textarea" label="备注">
              <mu-text-field style="border-radius: 4px; box-shadow: 0 2px 12px 0 rgba(0, 0, 0, 0.1);" multi-line :rows="3"
                :rows-max="6" v-model="form.textarea" disabled></mu-text-field>
            </mu-form-item>
