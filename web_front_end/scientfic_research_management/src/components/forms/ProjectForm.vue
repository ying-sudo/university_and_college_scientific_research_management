  ...
  <div>
    <mu-container>
      ...
      <mu-dialog
        ...
        :overlay-close="false"
        :open.sync="flag.openAlertProject"
      >
        ...
        <div style="height: 700px; overflow-y: scroll; padding: 10px;">
          <mu-container>
            ...
            >
              <mu-form-item
                class="mu-demo-min-form float_left"
                prop="input"
                label="项目名称"
              >
                <mu-text-field
                  v-model="project.name"
                  :disabled="flag.is_disabled"
                ></mu-text-field>
              </mu-form-item>
              ...
              <mu-form-item
                class="mu-demo-min-form"
                prop="input"
                label="批准文号"
              >
                <mu-text-field
                  v-model="project.approvalNumber"
                  :disabled="flag.is_disabled"
                ></mu-text-field>
              </mu-form-item>
              ...
              >
                <mu-select
                  v-model="project.collegeId"
                  :disabled="flag.is_disabled"
                >
                  <mu-option
                    v-for="option in collegeId"
                    :key="option.id"
                    :label="option.name"
                    :value="option.id"
                  ></mu-option>
              ...
              >
                <mu-select
                  v-model="project.firstDiscipline"
                  :disabled="flag.is_disabled"
                >
                  <mu-option
  ...
  data() {
    return {
      ...
      collegeId: [
        //成果归属
        // '计算机科学', '物电', '生物', '化学'
        { id: "0001", name: "中华传统文化学院" },
        { id: "0002", name: "国际教育学院" },
        { id: "0003", name: "马克思主义学院" },
        { id: "0006", name: "教育科学学院" },
        { id: "0007", name: "历史文化与旅游学院" },
        { id: "0008", name: "数学与软件科学学院" },
        { id: "0010", name: "化学与材料科学学院" },
        { id: "0014", name: "经济与管理学院" },
      ],
      userId: [
        //负责人
        "1",
      ...
      level: ["level1", "level2", "level3"], //项目级别
      sort: ["分类1", "分类2"],
      state: {
        id: [1, 2, 3],
        name: ["进行", "结束", "延期"],
