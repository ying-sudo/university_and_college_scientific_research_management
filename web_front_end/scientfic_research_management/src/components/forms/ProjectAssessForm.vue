    ...
    <mu-container>
      ...
      <el-dialog v-loading="loading" title="项目考核结果" class="el-dialog__title" style="font-size: 10px;" fullscreen
        ...
        <div style="padding: 10px; margin: 0 150px; float: left; width: 1500px;">
          <!-- <mu-container> -->
          <el-form style="float: left;" :model="project" ref="project" :label-position="labelPosition"
            label-width="1000">
            <el-form-item class="mu-demo-min-form" prop="name" label="项目名称">
              <el-input v-model="project.name" :disabled="flag.isDisabled"></el-input>
            </el-form-item>

            <el-form-item class="mu-demo-min-form" prop="id" label="项目编号">
              <el-input v-model="project.id" :disabled="flag.isDisabled"></el-input>
            </el-form-item>

            <el-form-item class="mu-demo-min-form" prop="approvalNumber" label="批准文号">
              <el-input v-model="project.approvalNumber" :disabled="flag.isDisabled"></el-input>
            </el-form-item>

            <el-form-item class="mu-demo-min-form" prop="userId" label="负责人学工号">
              <el-input v-model="project.userId" :disabled="flag.isDisabled"></el-input>
            </el-form-item>
            ...
            <el-form-item class="mu-demo-min-form" prop="characters" label="项目性质">
              <el-radio-group v-model="project.characters">
                <el-radio label="crosswise" :disabled="flag.isDisabled">横向</el-radio>
                <el-radio label="lengthways" :disabled="flag.isDisabled">纵向</el-radio>
              </el-radio-group>
            </el-form-item>
            ...
            <el-form-item class="mu-demo-min-form" prop="discipline" label="学科门类">
              <el-radio-group v-model="project.discipline">
                <el-radio label="science" :disabled="flag.isDisabled">理科类</el-radio>
            ...
            <el-form-item class="mu-demo-min-form" prop="beginDate" label="立项日期">
              <el-date-picker v-model="project.beginDate" type="date" placeholder="选择日期" :disabled="flag.isDisabled"
            ...
            <el-form-item class="mu-demo-min-form" prop="requestFund" label="申请经费">
              <el-input v-model.float="project.requestFund" :disabled="flag.isDisabled"></el-input>
            </el-form-item>
            ...
            <!-- 表单底部表格 -->
            <UserTable style="float: left; " v-model='users' :isDisabled="flag.isDisabled"></UserTable>
